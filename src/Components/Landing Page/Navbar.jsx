                ...
                <div className='flex justify-between items-center'>
                    ...
                    {verifyuser ? (
                        <div className='flex justify-between w-[20vw] sm:w-[10vw]'>
                            <i className="fa-regular fa-user cursor-pointer icon" style={{ fontSize: "18px" }} onClick={() => nav('/profile')} data-aos ="fade-up"s></i>
                            <i className="fa-solid fa-cart-shopping cursor-pointer icon" style={{ fontSize: "18px" }} onClick={navigatetocart } data-aos ="fade-up"s></i>
                            <i className="fa-solid fa-right-from-bracket cursor-pointer icon" style={{ fontSize: "18px" }} onClick={logout} data-aos ="fade-up"s></i>
                        </div>
                    ) : (
                        <Link to="/login">
                            <form action="" className='relative loginbt rounded-xl' data-aos = "fade-left">
